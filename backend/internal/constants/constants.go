...
const (
	...
	// Article endpoint rate limiting (higher limit for public article access)
	ArticleRateLimitRequestsPerMinute = 500 // 500 requests per minute for articles
	ArticleRateLimitBurst             = 100 // 100 burst for parallel category requests
)
