...
-- Using CHAR(36) to match tenants.id type for foreign key compatibility
ALTER TABLE reset_tokens ADD COLUMN tenant_id CHAR(36) NULL AFTER id;
...
ALTER TABLE reset_tokens MODIFY COLUMN tenant_id CHAR(36) NOT NULL;
